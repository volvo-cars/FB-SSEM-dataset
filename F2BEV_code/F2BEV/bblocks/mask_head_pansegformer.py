...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan  9 15:00:54 2023
...
# =============================================================================
        ...
        self.linear = nn.Sequential(
            nn.Linear(self.num_heads * 1, 1),####SEE HERE nn.Linear(self.num_heads * 2, 1),
            nn.ReLU(),
        )
...
##added by me
        new_feats = feats_l1 ##### SEE HERE new_feats = torch.cat([feats_l1,feats_l1],-1)
...
#         new_feats = torch.cat([feats_l1, feats_l2, feats_l3], -1)
# =============================================================================
        new_feats = torch.cat([feats_l1,feats_l1],-1)
        mask = self.linear(new_feats)
...
class MaskHead(nn.Module):
    def __init__(self,
        ...
        self.attnen = AttentionTail(d_model,
                                    num_heads=nhead,
                                    qkv_bias=qkv_bias,
                                    qk_scale=qk_scale,
                                    attn_drop=attn_drop_rate,
